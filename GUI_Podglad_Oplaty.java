...
public class GUI_Podglad_Oplaty{
    ...
    public ArrayList<String> oplaty_records;

    public GUI_Podglad_Oplaty(Polaczenie p, GUI_Login mainWindow){
    ...
    public void wypelnij(){
        oplaty_records =  a.getTableOplaty();
        String tmp;
        for(int i = 0; i < oplaty_records.size(); i++){
            tmp = oplaty_records.get(i);
