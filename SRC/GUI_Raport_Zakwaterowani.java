...
/**
 * Klasa GUI_Raport_Zakwaterowani
 * Klasa realizujaca podglad raportu o zakwatorowanych
 */

public class GUI_Raport_Zakwaterowani{
    public int login_id;
    ...
    public GUI_Raport_Zakwaterowani(Polaczenie p, GUI_Login mainWindow, int id){
        login_id = id;
    ...
    public void resolve(){
        RaportWrapper wartosci = a.getRaportZakwaterowani();
    ...
    public void resloveQuery2(){
        ...
        String query = "SELECT * FROM projekt.zakwaterowaniView WHERE "+nam+" = \'" + what + "\'";
        ...
        aktualizujCentralnyPanel(a.zakwaterowaniExecuteRaportQuery2(query));
    }
