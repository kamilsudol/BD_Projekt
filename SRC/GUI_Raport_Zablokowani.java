...
/**
 * Klasa GUI_Raport_Zablokowani
 * Klasa realizujaca podglad raportu o zablokowanych uzytkownikach
 */

public class GUI_Raport_Zablokowani{
    public int login_id;
    ...
    public GUI_Raport_Zablokowani(Polaczenie p, GUI_Login mainWindow, int id){
        login_id = id;
    ...
    public void resolve(){
        RaportWrapper wartosci = a.getRaportZablokowani();
    ...
    public void resloveQuery1(){
        ...
        String query = "SELECT "+nam+", COUNT("+nam+") AS zlicz FROM projekt.zablokowaniView GROUP BY " + nam;
        if(varCheck.isSelected()){
    ...
    public void resloveQuery2(){
        ...
        String query = "SELECT * FROM projekt.zablokowaniView WHERE "+nam+" = \'" + what + "\'";
        ...
        aktualizujCentralnyPanel(a.zablokowaniExecuteRaportQuery2(query));
    }
